...
//                Intent intent = new Intent(TStockChoiceActivity.this, TStockRegisterActivity.class);//まだETStockRegisterActivityを作成していない
//                startActivity(intent);
//            }
//        });
        Check_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(TStockChoiceActivity.this, TStockEditActivity.class); //まだEditActivityを作成していない
                startActivity(intent);
            }
        });
    }
